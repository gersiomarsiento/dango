...
import { useState } from "react"
 ...
 function Card ({onItemCountChange, defaultTitle, imgSrc, className }) {
    ...
    return (
        <div className="card-container ">
            <div className="flex flex-col place-self-center mt-2">
            ...
            <div className="flex flex-col m-2 p-5 border-4 border-black rounded-none overflow-hidden bg-white">
                <img className="w-full rounded-xl " src={imgSrc} alt="Tourmaly"></img>
                <div className="flex flex-col py-4">
                    ...
                    <div className="font-bold text-xl my-4">$12.00 <span><input className="border border-gray-400 w-1/6 text-xs text-gray-500 text-center align-middle mb-1 ml-2 leading-6 " type="number" value={itemCount || 0} onChange={(count) => changeItemCount(count)}/></span></div>
